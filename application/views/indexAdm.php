...
<br />
<table width="623" height="93" border="1" bordercolor="#0000FF">
  <tr bgcolor="#FFFF00" bordercolor="#FF0000" >
    <td width="27" align="center" ><strong><font color="#0000FF" size="-1">No</font></strong></td>
    <td width="118" align="center"><strong><font color="#0000FF" size="-1">Owner's Name</font></strong></td>
    <td width="107" align="center"><strong><font color="#0000FF" size="-1">Vehicle Type</font></strong></td>
    <td width="124" align="center"><strong><font color="#0000FF" size="-1">Brand Vehicles</font></strong></td>
    <td width="117" align="center"><strong><font color="#0000FF" size="-1">Police Numbers</font></strong></td>
  </tr>
  <?php $no=1?>
